...
class PulsediveConnector(BaseConnector):
    ...
    def __init__(self):
        ...
        super(PulsediveConnector, self).__init__()
    ...
    def _handle_search_indicator(self, param):
    ...
    def handle_action(self, param):
        ...
        elif action_id == 'search_indicator':
            ret_val = self._handle_search_indicator(param)
...
def main():
    ...
    if username and password:
        try:
            login_url = PulsediveConnector._get_phantom_base_url() + '/login'
